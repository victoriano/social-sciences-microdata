"""Label mappings applied to EPF 2023 fixed-width microdata.

These are extracted from the INE design-register Excel files so the pipeline
can produce human-readable CSVs without shipping the Excel sources themselves.
"""
...
# Consumption categories (ECOICOP) as shipped by INE for EPF 2023.
GASTOS_MAPPINGS = {
    "CODIGO": {
        "01111": "Arroz",
...
FILE_MAPPINGS = {
    "miembros": MIEMBROS_MAPPINGS,
    "gastos": GASTOS_MAPPINGS,
    "hogar": HOGARES_MAPPINGS,
}
