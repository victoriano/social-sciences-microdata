...
def convert_hogares():
    ...
    df = read_fixed_width_file('datos_2023/Fichero de usuario de hogar a2023IMPAJUSTE.txt', col_specs, col_names)
    df.to_csv('intermediate_outputs/EPFhogar_2023.csv', index=False)
...
def convert_gastos():
    ...
    df = read_fixed_width_file('datos_2023/Fichero de usuario de gastos a2023AJUSTE.txt', col_specs, col_names)
    df.to_csv('intermediate_outputs/EPFgastos_2023.csv', index=False)
...
def convert_miembros():
    ...
    file_name = 'datos_2023/Fichero de usuario de miembros a2023IMPAJUSTE.txt'
    df = read_fixed_width_file(file_name, col_specs, col_names)
    df.to_csv('intermediate_outputs/EPFmhogar_2023.csv', index=False)
